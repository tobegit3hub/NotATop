...
/* 经典游戏模式类，通过“抽打”陀螺维持旋转计算得分 */
public class ClassicGame extends GameFrame implements Runnable { // 继承游戏框架类，实现游戏必须实现的函数
	...
	/* 比较特别的变量 */
	private boolean difficultyFlag; // 表示难度增加的标志，用于在固定的时间点提高游戏的难度
